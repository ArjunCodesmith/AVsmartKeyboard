...
class SettingsActivity : Activity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnWordlist.setOnClickListener {
            startActivity(android.content.Intent(this, WordListEditorActivity::class.java))
        }
    }
    ...
    override fun onPause() {
        ...
        prefs.edit()
            .putInt("delay_ms", delayVal)
            .putString("after_action", if (spAfter.selectedItemPosition == 0) "space" else "enter")
            .apply()
    }
}
