package com.avsmart.keyboard.ui
...
import com.avsmart.keyboard.ui.wordlist.WordListEditorActivity
...
class SettingsActivity : Activity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        etDelay.setText(prefs.getInt("delay_ms", 800).toString())
    ...
    override fun onPause() {
        ...
        val etDelay = findViewById<EditText>(R.id.et_delay_setting)
        val spAfter = findViewById<Spinner>(R.id.sp_after)
        val delayVal = try { etDelay.text.toString().toInt() } catch (_: Exception) { 800 }
